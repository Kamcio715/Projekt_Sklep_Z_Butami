...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2026 at 08:45 PM
...
(7, '2026_05_30_205359_rename_polish_columns_in_orders_table', 1),
(8, '2026_05_30_205726_rename_polish_columns_in_shoes_table', 1),
(9, '2026_05_31_153654_add_stock_table', 1),
(10, '2026_05_31_153935_add_delivery_and_payment_to_orders_table', 1),
(11, '2026_05_31_163208_create_reviews_table', 1);
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `orders_id_klienta_foreign` (`user_id`);
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_id_klienta_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
