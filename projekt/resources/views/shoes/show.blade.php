                                    ...
                                    <div class="col-md-6">
                                        <div class="rating-card p-4">
                                            <div class="star-rating animated-stars">
                                                ...
                                                <label for="star5" class="bi bi-star-fill">⭐1</label>
                                                <input type="radio" id="star2" name="rating" value="2">
                                                <label for="star4" class="bi bi-star-fill">⭐2</label>
                                                <input type="radio" id="star3" name="rating" value="3">
                                                <label for="star3" class="bi bi-star-fill">⭐3</label>
                                                <input type="radio" id="star4" name="rating" value="4">
                                                <label for="star2" class="bi bi-star-fill">⭐4</label>
                                                <input type="radio" id="star5" name="rating" value="5">
                                                <label for="star1" class="bi bi-star-fill">⭐5</label>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            @auth
                                                @if(auth()->id() === $review->user_id)
                                                    <div class="review-actions">
                                                        <a style="color: white;" href="{{ route('reviews.edit', $review) }}" class="btn btn-outline-primary btn-sm">
                                                            Edytuj
                                                        </a>
